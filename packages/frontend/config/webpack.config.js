...
const useTailwind = existsSync(join(appPath, 'tailwind.config.js'));
  ...
  return {
    ...
    cache: {
      ...
      buildDependencies: {
        ...
        config: [__filename],
        tsconfig: [appTsConfig, appJsConfig].filter(f => existsSync(f)),
      },
    },
    ...
    plugins: [
      ...
      !disableESLintPlugin &&
        new ESLintPlugin({
          ...
          context: appSrc,
          cache: true,
          cacheLocation: _resolve(appNodeModules, '.cache/.eslintcache'),
